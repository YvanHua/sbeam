...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/sbeam/Source/AdminStaffLogin/admin.css">
  ...
  <body style="margin: 0 auto;padding:0;overflow:hidden;">
	...
	<script type="text/javascript" src="/sbeam/Source/AdminStaffLogin/admin.js"></script>
	<script type="text/javascript" src="/sbeam/Source/AdminStaffLogin/function.js"></script>
</body>
</html>
