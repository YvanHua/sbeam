            ...
            <tr>
                <td>
                    <div class="form-group" >
                        ...
                        <input type="text" class="form-control" id="account" placeholder="昵称" name="ticket.pcontent" >
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="form-group" >
                        ...
                        <input type="file" class="form-control" id="picture" placeholder="错误详情" name="upload" >
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <a  class="btn btn-default" href="/sbeam/customer/loginsuccess.jsp" role="button">返回</a>
                </td>
            </tr>
        </table>
    </s:form>
